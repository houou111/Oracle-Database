...
--              @latchprofx sid,name,ksllwnam,ksllwlbl % % 100000
--                                                              - monitor all sessions and latches and show
--                                                              - latch get Where and Label info (locations in kernel code
...
prompt
prompt -- LatchProfX 1.10 by Tanel Poder ( http://www.tanelpoder.com )
